...
where
    E: Engine
{
    pub fn try_new<P>(src: source::Answer<P,E>, input: AssignmentField<E>) -> Result<Self> 
    where
        P: ParameterSource<E>
    {
        let a: E::G1 = multiexp(
...
where
    E: Engine
{
    pub fn try_new<P>(src: source::Auxiliary<P,E>, assignment: AssignmentField<E>) -> Result<Self> 
    where
        P: ParameterSource<E>
    {
        let a: _ = multiexp(
